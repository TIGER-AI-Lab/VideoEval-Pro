...
class InternVL25():
    def __init__(self, model_path:str="OpenGVLab/InternVL2_5-8B", device="cuda") -> None:

        self.device = device
        attn_implementation = "flash_attention_2" if is_flash_attn_2_available() else None
        print(f"Using {attn_implementation} for attention implementation")

        from models.internvl25.modeling_internvl_chat import InternVLChatModel
        from models.internvl25.tokenization_internlm2 import InternLM2Tokenizer
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run InternVL2.5 inference on VideoEval-Pro dataset')
    ...
    parser.add_argument('--model_path', type=str, default="OpenGVLab/InternVL2_5-8B",
                        help='Path to InternVL2.5 model')
    ...
    model = InternVL25(model_path=args.model_path, device=args.device)
