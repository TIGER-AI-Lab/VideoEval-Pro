...
from models.vamba.configuration_qwen2_vl import Qwen2VLConfig
from models.vamba.modeling_qwen2_vl import Qwen2VLForConditionalGeneration
from models.vamba.processing_qwen2_vl import Qwen2VLProcessor
from models.vamba.image_processing_qwen2_vl import Qwen2VLImageProcessor
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run Vamba inference on VideoEval-Pro dataset')
    ...
    model = Vamba(model_path=args.model_path, device=args.device)
