...
class Idefics2():
    def __init__(self, model_path="TIGER-Lab/Mantis-8B-Idefics2", device="cuda") -> None:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run Idefics2 inference on VideoEval-Pro dataset')
    ...
    parser.add_argument('--model_path', type=str, default="TIGER-Lab/Mantis-8B-Idefics2",
                        help='Path to Idefics2 model')
    ...
    model = Idefics2(model_path=args.model_path, device=args.device)
