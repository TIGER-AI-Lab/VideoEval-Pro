...
class InternVideo25():
    def __init__(self, model_path:str="OpenGVLab/InternVideo2_5_Chat_8B", device="cuda") -> None:
        """Llava model wrapper
        ...
        from models.internvideo25.modeling_internvl_chat_hico2 import InternVLChatModel
        from models.internvideo25.tokenization_internlm2 import InternLM2Tokenizer
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run InternVideo2.5 inference on VideoEval-Pro dataset')
    ...
    parser.add_argument('--model_path', type=str, default="OpenGVLab/InternVideo2_5_Chat_8B",
                        help='Path to InternVideo2.5 model')
    ...
    model = InternVideo25(model_path=args.model_path, device=args.device)
