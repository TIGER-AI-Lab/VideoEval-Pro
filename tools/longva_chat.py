...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run LongVA inference on VideoEval-Pro dataset')
    ...
    parser.add_argument('--model_path', type=str, default="lmms-lab/LongVA-7B",
                        help='Path to LongVA model')
    ...
    model = LongVA(model_path=args.model_path, device=args.device)
