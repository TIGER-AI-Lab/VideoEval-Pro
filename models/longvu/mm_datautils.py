...
from models.longvu import conversation as conversation_lib

from models.longvu.constants import (
...
from models.longvu.mm_utils import KeywordsStoppingCriteria
...
def process_images(images, image_processor, model_cfg):
    if isinstance(image_processor, list):
        ...
        new_images_aux_list = [
            torch.stack(image_aux) for image_aux in new_images_aux_list
        ]
